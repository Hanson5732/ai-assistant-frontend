<template>
    <div class="p-6 bg-gray-50 min-h-screen relative">
        <div class="max-w-6xl mx-auto">
            ...
            <div v-else-if="folders.length > 0" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div v-for="folder in folders" :key="folder.id" 
                    ...
                    <div class="flex justify-between items-start mb-4">
                        <div class="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-500 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                    ...
                    <div class="mt-auto">
                        <h3 class="text-lg font-bold text-gray-800 mb-1 truncate" :title="folder.name">{{ folder.name }}</h3>
...
import { getFolderList, createFolder, deleteFolder } from '@/apis/folder'
